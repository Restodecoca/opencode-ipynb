...
const NOTEBOOK_DIR = path.resolve(__dirname, "classification")
...
describeIf(realHelperEnabled(), "integration > classification", () => {
  it.skipIf(
    !pythonHas("sklearn") || !pythonHas("numpy")
